...
namespace SharpDetectionNTLMSSP.FunModule
{
    class NTLMSSPBuffer
    {
        ...
        // SMB_COM_NEGOTIATE（0x72）- 版本协商
        public static byte[] smb_buffer_v1 = {
        ...
        public static byte[] smb_buffer_v2 = {
        ...
        #region row shellcode rdp

        #endregion

        #region row shellcode mssql

        public static byte[] mssql_buffer_v1 = {
        ...
        public static byte[] mssql_buffer_v2 = {
